...
library("metafor")
library("Rmisc")
library("plotrix")  # install.packages()
library("tiff")


### read table- need to direct ot wherever table from Antone et al. is on your computer
dat<-read.csv("/Users/geraldn/Dropbox/Invasion calamity shared/Data_final/Final_csv/quant_FINAL_11.csv",
                  header=T,sep=",") 
## update names
